	...
	<div class="col-9 mbg-azure pt-2">
		...
		<div class="row">
			...
			<div class="col-8">
				...
				<div class="row my-3">
					<label class="col-sm-3 fw-bold">Màn hình: </label>
					<div class="col-sm-9">${product.display}</div>
				</div>
				<div class="row my-3">
					<label class="col-sm-3 fw-bold">Độ phân giải: </label>
					<div class="col-sm-9">${product.resolution}</div>
				</div>
				<div class="row my-3">
					<label class="col-sm-3 fw-bold">Hệ điều hành: </label>
					<div class="col-sm-9">${product.system}</div>
				</div>
				<div class="row my-3">
					<label class="col-sm-3 fw-bold">Chip xử lí (CPU): </label>
					<div class="col-sm-9">${product.CPU}</div>
				</div>
				<div class="row my-3">
					<label class="col-sm-3 fw-bold">Dung lượng RAM: </label>
					<div class="col-sm-9">${product.RAM}</div>
				</div>
				<div class="row my-3">
					<label class="col-sm-3 fw-bold">SIM: </label>
					<div class="col-sm-9">${product.SIM}</div>
				</div>
				<div class="row my-3">
					<label class="col-sm-3 fw-bold">Pin: </label>
					<div class="col-sm-9">${product.battery}</div>
				</div>	
			</div>
